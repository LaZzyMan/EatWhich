...
class JNStarRateView: UIView {
    ...
    fileprivate func createStarView()->(){
        starBackgroundView = starViewWithImageName(#imageLiteral(resourceName: "backgroundStar"))
        starForegroundView = starViewWithImageName(#imageLiteral(resourceName: "foregroundStar"))
    ...
    fileprivate func starViewWithImageName(_ imageName: UIImage) -> UIView {
